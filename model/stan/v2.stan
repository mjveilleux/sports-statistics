...
parameters {
  ...
  real<lower=0.000001> sigma_games; // game-level variance in point differential
  real<lower=0.000001> sigma_teams; // across team variance before season
  real<lower=0.000001> sigma_seasons; // across season variance within team
